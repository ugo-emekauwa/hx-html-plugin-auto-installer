"""
HyperFlex HTML Plug-In Automated Installer v2
Author: Ugo Emekauwa
...
Notes: Tested on Cisco HyperFlex HTML Plug-In for VMware vCenter 2.1.0, HyperFlex 5.0(1a), and VMware vCenter 7.0.1.003
"""
